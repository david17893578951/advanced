...
use backend\models\Directiva;

/**
 * DirectivaSearch represents the model behind the search form about `backend\models\Directiva`.
 */
class DirectivaSearch extends Directiva {
    ...
    public function rules() {
        return [
                ...
                [['id_directiva', 'id_unapes', 'id_cargo', 'id_miembro', 'id_periodo'], 'safe'],
        ];
    }
